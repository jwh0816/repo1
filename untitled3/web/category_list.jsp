    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
        	<div class="list_t">
                ...
                <span class="fr">共发现${requestScope.Pagination.totalRecord}件</span>
            </div>
            <div class="list_c">
                <ul class="cate_list">
                   <%--${requestScope.Pagination}  Pagination 对象 --%>
                   <c:forEach items="${requestScope.Pagination.data}" var="obj">
                	<li>
                    	<div class="img"><a href="#"><img src=${obj.img_path} width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span>${obj.price}</span></font> &nbsp;
                        </div>
                        <div class="name"><a href="#">${obj.goods_name}</a></div>
                        <div class="carbg">
                        	<a href="#" class="ss">收藏</a>
                         <a href="javascript:gouwuche(${obj.goods_id})" class="j_car">加入购物车</a>
                        </div>
                    </li>
                   </c:forEach>
                </ul>
                ...
                <div class="pages">
                    <c:forEach begin="1" end="${requestScope.Pagination.totalPage}" step="1" var="pageIndex">
                        <%--<c:if test="${requestScope.Pagination.currPage!=pageIndex}">
                            ${pageIndex}
                        </c:if>--%>
                        <c:if test="${requestScope.Pagination.currPage==pageIndex}">
                            <span style="display: inline-block;background:#FF4E00;width:36px;height:36px;"> <a href="queryData?currPage=${pageIndex}&key=${key}">${pageIndex}</a></span>
                        </c:if>
                        <c:if test="${requestScope.Pagination.currPage!=pageIndex}">
                           <a href="queryData?currPage=${pageIndex}&key=${key}">${pageIndex}</a>
                        </c:if>
                    </c:forEach>
                </div>
