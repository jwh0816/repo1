              ...
              <tr>
                ...
                <td style="font-size:12px; padding-top:20px;">
                	<span style="font-family:'宋体';" class="fl">
                    	<label class="r_rad"><input type="checkbox" name="jizhumima" /></label><label class="r_txt">请保存我这次的登录信息</label>
                    </span>
...
%>            
              <tr height="60">
              	<td>&nbsp;</td>
                <td><input type="submit" value="登录" id="loginBtn" class="log_btn" /></td>
              </tr>
            </table>
            </form>
        </div>
